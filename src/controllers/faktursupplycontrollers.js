...
const getDataFaktursupplyById = async (req, res) => {
    ...
    const data = await new Promise((resolve, reject) => {
        const query = "SELECT * FROM faktursupply WHERE id_supply = ?";
...
const editDataFaktursupply = async (req, res) => {
    ...
    const result = await new Promise((resolve, reject) => {
        const query = 'UPDATE faktursupply SET ? where id_supply = ?';
...
const deleteDataFaktursupply = async (req, res) => {
    ...
    const result = await new Promise((resolve, reject) => {
        const query = 'DELETE FROM faktursupply where id_supply = ?';
        connection.query(query, [id], function (err, rows) {
            if (rows) {
                resolve(rows);
            } else {
